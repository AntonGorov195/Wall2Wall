	...
	(GL = {
		...
		validateGLObjectID: function (e, t, n, s) {
			t != 0 &&
				(e[t] === null
					? console.error(
							n + " called with an already deleted " + s + " ID " + t + "!"
					  )
					: e[t] ||
					  console.error(
							n + " called with an invalid " + s + " ID " + t + "!"
					  ));
		},
		...
		populateUniformTable: function (e) {
			...
			for (
				var t,
					...
					d = r.uniforms,
					u = gl.getProgramParameter(o, 35718),
					c = 0;
				c < u;
				++c
			)
				if (
					((i = gl.getActiveUniform(o, c)),
					(t = i.name),
...
function _webglGet(e, t, n) {
	...
	switch (e) {
		case 36346:
			...
			break;
		case 36344:
			n != "EM_FUNC_SIG_PARAM_I" &&
				n != "EM_FUNC_SIG_PARAM_I64" &&
				(GL.recordError(1280),
				err(
		...
		env: {
			...
			glTexImage2D: function (e, t, n, s, o, i, a, r, c) {
				gl.texImage2D(
					...
					a,
					r,
					c ? getArray(c, Uint8Array, texture_size(n, s, o)) : null
				);
			},
			glTexSubImage2D: function (e, t, n, s, o, i, a, r, c) {
				gl.texSubImage2D(
					...
					a,
					r,
					c ? getArray(c, Uint8Array, texture_size(a, o, i)) : null
				);
			},
			...
			glGetProgramiv: function (e, t, n) {
				...
				if (t == 35716)
					...
					getArray(n, Int32Array, 1)[0] = gl.getProgramParameter(
						GL.programs[e],
						t
					);
			},
...
`),
					...
					o.indexOf("attribute") != -1
						? ((o = o.replace(/attribute/g, "in")),
						  (o = o.replace(/varying/g, "out")))
						: (o = o.replace(/varying/g, "in")),
...
` + i
			...
			glGetShaderiv: function (e, t, n) {
				if (
					...
					t == 35720
						? ((s = gl.getShaderSource(GL.shaders[e])),
						  (i = s === null || s.length == 0 ? 0 : s.length + 1),
						  (getArray(n, Int32Array, 1)[0] = i))
						: (getArray(n, Int32Array, 1)[0] = gl.getShaderParameter(
								GL.shaders[e],
								t
						  ));
			},
			...
			glDeleteBuffers: function (e, t) {
				for (var n, o, s = 0; s < e; s++) {
					if (
						((o = getArray(t + s * 4, Uint32Array, 1)[0]),
						(n = GL.buffers[o]),
						!n)
					)
						continue;
			...
			glDeleteQueries: function (e) {
				for (var n, o, s = 0; s < e; s++) {
					if (
						((o = getArray(textures + s * 4, Uint32Array, 1)[0]),
						(n = GL.timerQueries[o]),
						!n)
					)
						continue;
			...
			run_animation_loop: function (e) {
				(canvas.onmousemove = function (e) {
					...
					wasm_exports.mouse_move(Math.floor(n), Math.floor(s)),
						(e.movementX != 0 || e.movementY != 0) &&
							wasm_exports.raw_mouse_move(
								Math.floor(e.movementX),
								Math.floor(e.movementY)
							);
				}),
					...
					window.addEventListener("paste", function (e) {
						...
						t != null &&
							t.length != 0 &&
							((n = new TextEncoder().encode(t).length),
							(s = wasm_exports.allocate_vec_u8(n)),
							(o = new Uint8Array(wasm_memory.buffer, s, n)),
...
function register_plugins(e) {
	...
	for (var t = 0; t < e.length; t++)
		e[t].register_plugin != void 0 &&
			e[t].register_plugin != null &&
			e[t].register_plugin(importObject);
}
			...
			(n.env.js_create_string = function (e, n) {
				...
				(n.env.js_unwrap_to_str = function (t, n, o) {
					for (
						var r = e[t],
							a = s(r),
							c = a.length,
							l = new Uint8Array(wasm_memory.buffer, n, o),
							i = 0;
						i < c;
						i++
					)
				...
				(n.env.js_unwrap_to_buf = function (t, n, s) {
					for (
						var i = e[t],
							a = i.length,
							r = new Uint8Array(wasm_memory.buffer, n, s),
							o = 0;
						o < a;
						o++
					)
